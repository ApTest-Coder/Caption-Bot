"""Local deployment configuration for Caption Bot.

This tracked file intentionally contains placeholders only. Replace them on
self-hosted deployments; never commit real credentials.
"""
